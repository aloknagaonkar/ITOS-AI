...
### Hardened result mapping
A successful function return is not treated as universal date success. The guided boundary consumes each service result, advances only eligible dates, and calculates work-unit progress from real completed, skipped, pending, no-data and failed facts.
