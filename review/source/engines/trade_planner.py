...
class InstitutionalDecisionMatrixEngine(BaseEngine):
    ...
    def analyze(self, market_data: DecisionContext | Mapping[str, Any]) -> EngineResult:
        ...
        liquidity_value = components.get("Liquidity")
        if liquidity_value is None and isinstance(metrics, InstitutionalMetrics):
            liquidity_value = metrics.liquidity.liquidity_score
        liquidity = _num(liquidity_value, 50)
    ...
    def _adapt_input(
        ...
        if isinstance(market_data, DecisionContext):
            ...
            return {
                ...
                "intelligence": market_data.market_snapshot.intelligence,
                ...
                "false_breakout_result": results.get("false_breakout"),
        ...
        if not isinstance(normalized.get("intelligence"), Mapping):
