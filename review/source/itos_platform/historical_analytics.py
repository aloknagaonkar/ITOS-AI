...
class HistoricalAnalyticsService:
    ...
    def _aggregate(self, request: HistoricalAnalyticsRequest, records: tuple[HistoricalIntelligenceRecord, ...],
        ...
        result = HistoricalAnalyticsResult(
            ...
            tuple(sorted({r.engine_version for r in records} or {engine})), raw_dates, missing,
            ...
            _counts(top_ce)[:5], _counts(top_pe)[:5], _counts(top_overall)[:5], horizon(5), horizon(15), horizon(30),
            _average(eod), _average([o.maximum_favourable_excursion for o in outcomes]),
