...
- Finalized Historical index readiness mapping: failed, indexed/current, and zero-count pending results now remain distinct; index failures explicitly report Similarity unavailable.
- Removed the misleading synchronous Streamlit cancellation action while retaining programmatic orchestration cancellation support.
