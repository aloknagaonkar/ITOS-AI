...
class DashboardApplicationService:
    ...
    def execute(
        ...
        smart_candle_result = SmartCandlestickEngine().analyze(decision_context)
        decision_context.engine_results["smart_candlestick"] = smart_candle_result
        structure_result = InstitutionalStructureEngine().analyze(decision_context)
        decision_context.engine_results["institutional_structure"] = structure_result
        ...
        decision_context.engine_results["institutional_footprint"] = footprint_result
